...
M.highlights_base = function(colors)
	return {
		...
		CursorLineNr = { fg = colors.color1, bg = colors.background },
		...
		LineNrAbove = { fg = colors.transparent, bg = colors.background },
		LineNrBelow = { fg = colors.transparent, bg = colors.background },
